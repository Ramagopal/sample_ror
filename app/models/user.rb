class User < ApplicationRecord
	...
	validates :password, presence: true, length: { maximum: 100, minimum: 4 }, on: :create
	validates :confirm_password, presence: true, length: { maximum: 100, minimum: 4 }, on: :create
